                        ...
                        <div className="form-wrap">
                            <form>
                                ...
                                <div className="inputs-wrap">
                                    ...
                                    <br />
                                    <div className="wrap">
                                        <label className='font-bold text-md ml-2'>Confirm Password</label> <br />
                                        <input type="password" className='mt-1 bg-gray-100 w-full  border-0 p-4 rounded-full' placeholder='xxxxxxxxxxx' />
                                    </div>
                                </div>
                                ...
                                <div className="btn-wrap mt-5">
                                    ...
                                    <p className='text-black text-right'> Already have an account? <span className='text-primary font-bold cursor-pointer' onClick={() => navi('/auth/login')}>Login</span></p>
                                </div>
                            </form>
                        </div>
                    </div>
