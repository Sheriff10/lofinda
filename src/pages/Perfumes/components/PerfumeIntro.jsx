        ...
        <div className="wrap py-32">
            <Container>
                <div className="text-wrap min-h-[50vh] flex justify-center items-center text-center text-lg font-bold">
                    <div className="wrap">
                        <span className='italic'>We sell scents, body mist, rolls, perfumes and anything aroma related, just to ensure your absolute needs are met. <br /> We believe in smelling good, Don’t you?</span>
                        <div className="wrap mt-8 text-purple-400">
